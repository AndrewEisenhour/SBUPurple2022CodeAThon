...
public class LifePathOneOneSeven extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.next3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(LifePathOneOneSeven.this)
                        .navigate(R.id.action_lifePathOneOneSeven_to_lifePathOneOneEight);
            }
        });
        binding.back4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(LifePathOneOneSeven.this)
                        .navigate(R.id.action_lifePathOneOneSeven_to_lifePathOneOneSix);
            }
        });
        binding.tiehome2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(LifePathOneOneSeven.this)
                        .navigate(R.id.action_lifePathOneOneSeven_to_lifePathOneOne);
            }
        });
    }

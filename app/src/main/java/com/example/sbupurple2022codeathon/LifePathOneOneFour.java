...
public class LifePathOneOneFour extends Fragment {
    ...
    public void onViewCreated(@NonNull View view, Bundle savedInstanceState) {
        ...
        binding.next3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(LifePathOneOneFour.this)
                        .navigate(R.id.action_lifePathOneOneFour_to_lifePathOneOneFive);
            }
        });
        binding.back4.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(LifePathOneOneFour.this)
                        .navigate(R.id.action_lifePathOneOneFour_to_lifePathOneOneThree);
            }
        });
        binding.tiehome2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                NavHostFragment.findNavController(LifePathOneOneFour.this)
                        .navigate(R.id.action_lifePathOneOneFour_to_lifePathOneOne);
            }
        });
    }
